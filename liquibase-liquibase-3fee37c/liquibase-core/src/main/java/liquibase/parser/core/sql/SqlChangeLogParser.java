...
public class SqlChangeLogParser implements ChangeLogParser {
    ...
    public DatabaseChangeLog parse(String physicalChangeLogLocation, ChangeLogParameters changeLogParameters, ResourceAccessor resourceAccessor, String revisionNo, Boolean failOnError) throws ChangeLogParseException {
