...
public class Liquibase {
    ...
    public void update(String contexts) throws LiquibaseException {
        ...
        try {
            DatabaseChangeLog changeLog = ChangeLogParserFactory.getInstance().getParser(changeLogFile, resourceAccessor).parse(changeLogFile, changeLogParameters, resourceAccessor, "",null);;
